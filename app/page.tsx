...
const experience = [
  ...
  },
  {
    ...
    points: [
      ...
      "Show students how to calculate RPM, Feed rate, and other critical manufacturing values to program and machine each part of the Sterling Engine.",
    ],
  },
];
  ...
  return (
    <main className="min-h-screen bg-zinc-950 text-zinc-100 antialiased">
      ...
      <section id="top" className="mx-auto max-w-5xl px-6 pb-20 pt-20 md:pt-28">
        ...
        <img src="/Professional.png" alt="Elijah Akpan" className="aspect-[4/5] w-full rounded-lg object-cover" /> 
        </div>
      ...
      <section id="projects" className="border-t border-zinc-800/60 py-20">
        <div className="mx-auto max-w-5xl px-6">
          ...
          <img src="porsche.jpeg" alt="RideOnCar" className="aspect-[4/3] w-full rounded-lg object-cover" />
            <div>
              ...
              <p className="mt-4 text-zinc-400">
                Invented a device that can dynamically generate engine sounds similar to real car&apos;s in response to pedal feedback,
                Built using a RPI platform that's routed to a custom PCB. Currently patent pending.
              </p>
              <Link
                href="/patent"
                className="mt-6 inline-block font-mono text-xs uppercase tracking-widest text-[#ff5a1f] transition-opacity hover:opacity-70"
